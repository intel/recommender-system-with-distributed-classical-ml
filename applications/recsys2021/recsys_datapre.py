...
def inference_decoder(is_local):
    ############# set up
    path_prefix = f"hdfs://{MASTER}:9000/"
    current_path = "/recsys2021/datapre_stage1/"
...
if __name__ == "__main__":
    ...
    mode = sys.argv[1]
    MASTER = sys.argv[2]
    is_local = int(sys.argv[3])

    if mode == "train":
        train(is_local)
    elif mode == "valid_stage1":
        valid_stage1(is_local)
    elif mode == "valid_stage2":
        valid_stage2(is_local)
    elif mode == "inference_decoder":
        inference_decoder(is_local)
    elif mode == "inference_join":
        inference_join(is_local)
